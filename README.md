...
1. **Unduh proyek atau kloning repositori**:
    ```bash
    git clone https://github.com/hanung665/wedding-invitation.git
    ```

2. **Catatan**: Anda memiliki dua pilihan untuk menggunakan kode sumber ini:
    - **Tanpa Modifikasi**: Buka file [data.js](https://github.com/hanung665/wedding-invitation/blob/main/src/assets/data/data.js) untuk langsung menggunakannya.
...
Proyek ini merupakan redesain dari undangan pernikahan milik [Sandi](htt://github.com/sdprdh) dan [Dewanakl](https://github.com/dewanakl). Tata letak dan desain telah disesuaikan untuk meningkatkan fungsi dan estetika serta kebutuhan pribadi.
